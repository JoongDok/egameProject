...
<c:choose>
	<c:when test="${!empty cartList}">
		<!-- 장바구니 -->
		<div id="cart" style="width: 60%; min-height: 450px; margin: 0 auto; margin-top: 50px; margin-bottom: 50px;">
			...
			<c:forEach var="cartList" items="${cartList}" varStatus="status">         
		            <tr>
		                ...
		                <td class="cart_table_td1">
		                    ...
		                    <img src="/resources/img_library/${cartList.productName}.jpg" width="30%">
