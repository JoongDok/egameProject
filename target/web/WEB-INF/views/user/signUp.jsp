...
function fn_userReg2()
{
	$.ajax({
		...
		data:{
			...
			userBusinessNum:$("#businessNum").val()
            ...
            <div class="col-lg-6">
                <div class="login__form" style="padding-left: 370px;">
                    ...
                    <form action="/user/login">
                        ...
                        <div>
                            <input type="checkbox" name="userClass" id="userClass" value="5"/>
                            <span style="color: rgb(180, 179, 179);">상품을 판매합니까?</span>
                            <span style="color: rgb(181, 5, 5);">예</span>
                        </div>
                        <div class="input__item" id="businessNumBox" style="display:none">
                                <label style="position: relative;">
                                <input type="text" placeholder="사업자등록번호" id="businessNum" style="width: 370px;" value="" >
                                <span class="icon_lock"></span>
                                <button type="button" onclick="fn_userReg2()" style="position: absolute; right: 5px; border-radius: 5px; border: none; background-color: #212483; color: white;">중복체크</button> -->
                            	</label>
                        </div>
                        <input type="hidden" id="userPwd" name="userPwd" value="" />
                        <button type="button" id="btnReg" class="site-btn" onclick="fn_userRegChk()">회원가입</button>
                        
                    </form>
                    <h5>아이디가 있습니까? <a href="/login">로그인</a></h5>
                </div>
            </div>
        </div>
    </div>
