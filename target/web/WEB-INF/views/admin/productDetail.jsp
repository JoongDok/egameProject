        ...
        <div class="container">
          <div class="detail__hero__items">
            ...
            <div class="detail__img">
              <img
                src="/resources/img_detail/HogwartsLegacy_detail_01.jpg"
                width="100"
                height="56.2"
                id="img1"
              ...
              />
              <img
                src="/resources/img_detail/HogwartsLegacy_detail_02.jpg"
                width="100"
                height="56.2"
                id="img2"
                style="padding-right: 10px"
              />
              <img
                src="/resources/img_detail/HogwartsLegacy_detail_03.jpg"
                width="100"
                height="56.2"
                id="img3"
                style="padding-right: 10px"
              />
              <img
                src="/resources/img_detail/HogwartsLegacy_detail_04.jpg"
                width="100"
                height="56.2"
                id="img4"
                style="padding-right: 10px"
                        ...
                        <ul>
                            ...
                            <li>
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <div class="anime__details__btn">
                                            <a href="javascript:void(0)" class="watch-btn" onclick="fn_discnt_update(${discntCheck.discntSeq})"
                                            ><span style="font-size: 16px" id="productStatusHtml">수정하기</span>
                                           </a>
                                        </div>
                  ...
                  <c:forEach var="review" items="${reviewList}" varStatus="status">
                    ...
                    <div class="anime__review__item">
                      ...
                      <div class="anime__review__item__pic">
                        <img src="/resources/img_userimg/user_01.jpg" alt="" />
   ...
   <%@ include file="/WEB-INF/views/include/footer.jsp" %>
    ...
    <script>
      $(document).ready(function (e) {
        ...
        $("#detailMain").html(
          "<img src='/resources/img_detail/HogwartsLegacy_detail_01.jpg' width='100%' height='550px'>"
        );
        ...
        $("#img2").on("click", function () {
          $("#detailMain").html(
            "<img src='/resources/img_detail/HogwartsLegacy_detail_02.jpg' width='100%' height='550px'>"
          );
        });
        $("#img3").on("click", function () {
          $("#detailMain").html(
            "<img src='/resources/img_detail/HogwartsLegacy_detail_03.jpg' width='100%' height='550px'>"
          );
        });
        $("#img4").on("click", function () {
          $("#detailMain").html(
            "<img src='/resources/img_detail/HogwartsLegacy_detail_04.jpg' width='100%' height='550px'>"
          );
        });
        
        const productGrade = $("#productGrade").val();
