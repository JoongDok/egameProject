...
<section class="hero">
    <div class="container">
        <div class="hero__slider owl-carousel">
            <div class="hero__items set-bg" data-setbg="/resources/img_detail/HogwartsLegacy.jpg">
                <div class="row">
                    <div class="col-lg-6">
            ...
            <div class="hero__items set-bg" data-setbg="/resources/img_detail/DeadSpace.jpg">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="hero__text">
                            <h2>Dead Space</h2>
            ...
            <div class="hero__items set-bg" data-setbg="/resources/img_detail/RedDeadRedemption2.jpg">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="hero__text">
                                       ...
                                       <h5><a href="javascript:void(0)" onclick="fn_detail(${p.productSeq})">${p.productName}<br>
                                        <c:choose>
                                            <c:when test="${p.discntSeq gt 0}">
                                                <strike>₩ ${p.productPrice}</strike> -&gt;  ₩ ${p.printPayPrice}
                                                    </a>
