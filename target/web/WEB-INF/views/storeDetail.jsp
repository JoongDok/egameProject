        ...
        <div class="container">
          <div class="detail__hero__items">
            ...
            <div class="detail__img">
              <img
                src="/resources/game_detail/${product.productName}_1.jpg"
                width="100"
                height="56.2"
                id="img1"
              ...
              />
              <img
                src="/resources/game_detail/${product.productName}_2.jpg"
                width="100"
                height="56.2"
                id="img2"
                style="padding-right: 10px"
              />
              <img
                src="/resources/game_detail/${product.productName}_3.jpg"
                width="100"
                height="56.2"
                id="img3"
                style="padding-right: 10px"
                    ...
                    <div class="anime__review__item">
                      ...
                      <div class="anime__review__item__text">
                        <h6 id="review_title">
                          ...
                          <span><a href="javascript:void(0)" onclick="fn_review_modal_on(${review.reviewSeq})">신고<i class="fa fa-flag"></i></a></span>
                        </h6>
                        <p id="myContent">
   ...
   <%@ include file="/WEB-INF/views/include/footer.jsp" %>
    ...
    <script>
      $(document).ready(function (e) {
        ...
        $("#detailMain").html(
          "<img src='/resources/game_detail/${product.productName}_1.jpg' width='100%' height='550px'>"
        );
        ...
        $("#img2").on("click", function () {
          $("#detailMain").html(
            "<img src='/resources/game_detail/${product.productName}_2.jpg' width='100%' height='550px'>"
          );
        });
        $("#img3").on("click", function () {
          $("#detailMain").html(
            "<img src='/resources/game_detail/${product.productName}_3.jpg' width='100%' height='550px'>"
          );
        });
