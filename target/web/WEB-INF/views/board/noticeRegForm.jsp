...
<div id="div1">
    ...
    <div class="container">
        ...
        <form name="noticeWriteForm" id="noticeWriteForm" method="post">
            <input type="text" name="noticeTitle" id="noticeTitle" maxlength="50" class="form-control mb-2" placeholder="제목을 입력해주세요." required />
            <div class="form-group">
                <textarea class="form-control" rows="10" name="noticeContent" id="noticeContent" placeholder="내용을 입력해주세요" required></textarea>
            </div>
