...
<!-- Breadcrumb End -->
	...
	<section class="notice_gallery_section">
		<a href="/"><article><div><img src="/resources/img_library/AssasinsCreedValhalla.jpg"></div><small>신규 게임 소식</small><p class="notice_gallery_text">ㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇ</p></article></a>
		<a href="/"><article><div><img src="/resources/img_library/DeadSpace.jpg"></div><small>불법 거래 재제</small><p class="notice_gallery_text">가나다라마바사dddddd아자asdad차카타파하가나다라마바사아자차카타파하가나다라마바사아자차카타파하가나다라마바사아자차카타파하</p></article></a>
		<a href="/"><article><div><img src="/resources/img_library/HogwartsLegacy.jpg"></div><small>연간 할인 계획</small><p class="notice_gallery_text">가나다라마바사dddd아자차카타파하가dd나adasd다라마바사아자차카타파하가나다라마바사아자차카타파하가나다라마바사아자차카타파하</p></article></a>
		<a href="/"><article><div><img src="/resources/img_library/RedDeadRedemption2.jpg"></div><small>신규 게임 소식</small><p class="notice_gallery_text">가나다라마바사dddd아자dd차asdsasd카타파하가나다라마바사아자차카타파하가나다라마바사아자차카타파하가나다라마바사아자차카타파하</p></article></a>
	</section>
		...
		<c:if test="${!empty list}">
			<c:forEach var="notice" items="${list}" varStatus="status">
				<tr>
					...
					<th>
						<a href="javascript:void(0)" onclick="fn_noticeDetail(${notice.noticeSeq})" class="notice_list">
